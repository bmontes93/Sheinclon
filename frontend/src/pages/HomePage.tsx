...
const HomePage = () => {
  const [products, setProducts] = useState<any[]>([]); // TODO: Definir interfaz Product adecuada
  ...
  const fetchProducts = async (page = 1, filters: Filters = {}) => {
    try {
      setLoading(true);
      setError(null);
      ...
      const params: Record<string, string> = {
        ...
        pageSize: config.ITEMS_PER_PAGE.toString(),
      };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto p-4 lg:p-8">
        <div className="mb-12 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900">Tendencias del Momento</h2>
